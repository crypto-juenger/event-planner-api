...
class EventControllerApi {
  ...
  const EventControllerApi(this._dio, this._serializers);
  ...
  Future<Response<EventDto>> createEvent({ 
    ...
    try {
      const _type = FullType(CreateEventConfigDto);
      _bodyData = _serializers.serialize(createEventConfigDto, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EventDtos] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventDtos>> getAllEventsForUser({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    EventDtos _responseData;

    try {
      const _responseType = FullType(EventDtos);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as EventDtos;

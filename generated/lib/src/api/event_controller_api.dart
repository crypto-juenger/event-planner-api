...
class EventControllerApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PublicUserDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<PublicUserDto>> getEventUserInformation({ 
    ...
    final _path = r'/api/events/{eventId}/users/me'.replaceAll('{' r'eventId' '}', eventId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    PublicUserDto _responseData;

    try {
      const _responseType = FullType(PublicUserDto);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PublicUserDto;
  ...
  /// Returns a [Future] containing a [Response] with a [EventDto] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventDto>> joinEventWithJoinKey({ 
    ...
    final _path = r'/api/events/joinKey/{joinKey}/users'.replaceAll('{' r'joinKey' '}', joinKey.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
